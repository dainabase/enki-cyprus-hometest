      ...
      <Card className="bg-white shadow-lg border border-gray-200">
        <CardContent className="p-6">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-xl font-semibold text-gray-800">Recherche Avancée</h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
            ...
            <div className="space-y-2">
              ...
              <select
                ...
                className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white text-gray-800 transition-colors"
              >
            ...
            <div className="flex flex-col justify-end gap-2">
              ...
              >
                <Button 
                  className="w-full bg-blue-600 hover:bg-blue-700 text-white px-6 py-2 rounded-lg font-medium transition-colors flex items-center gap-2"
