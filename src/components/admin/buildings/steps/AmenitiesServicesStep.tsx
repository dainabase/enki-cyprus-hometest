...
import { Home, Coffee, Waves, ParkingCircle } from 'lucide-react';
              ...
              <Card>
                <CardContent className="p-6">
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>Nombre total de places</FormLabel>
                        <FormControl>
                          <Input
                            {...field}
                            type="number"
              ...
              <Card>
                <CardContent className="p-6">
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>Places visiteurs</FormLabel>
                        <FormControl>
                          <Input
                            {...field}
                            type="number"
              ...
              <Card>
                <CardContent className="p-6">
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>Places handicapés (PMR)</FormLabel>
                        <FormControl>
                          <Input
                            {...field}
                            type="number"
              ...
              <Card>
                <CardContent className="p-6">
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>Box fermés</FormLabel>
                        <FormControl>
                          <Input
                            {...field}
                            type="number"
