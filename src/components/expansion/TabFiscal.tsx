...
export const TabFiscal = ({ property }: TabFiscalProps) => {
  ...
  const { openLexaia } = usePropertyExpansion();
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="bg-black/5 border border-black/10 p-8 text-center">
        ...
        <button
          onClick={() => openLexaia(property.id)}
          className="inline-flex items-center gap-2 bg-black hover:bg-black/90 text-white px-6 py-3 font-medium transition-colors"
        >
