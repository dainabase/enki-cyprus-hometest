...
// Variante 1: Input et bouton dans la même zone
const ChatVariant1 = () => {
  ...
  return (
    <section className="relative min-h-screen w-full flex flex-col items-center justify-center overflow-hidden">
      ...
      {/* Chat Interface - Input et bouton intégrés */}
      <motion.div
      ...
      >
        <div className="relative bg-white/95 backdrop-blur-xl border border-white/30 rounded-3xl p-8 shadow-2xl">
          {/* Message avec taille fixe */}
          <div className="mb-6 p-6 bg-gray-50/70 backdrop-blur-sm rounded-2xl border border-gray-100/50 h-32 overflow-hidden">
          ...
          <div className="relative">
            <Input
              ...
              className="w-full h-14 pr-16 border-gray-200/50 focus:border-primary bg-white/90 backdrop-blur-sm rounded-2xl text-base"
              onKeyPress={(e) => e.key === 'Enter' && handleSendMessage()}
            />
            <motion.button
              onClick={handleSendMessage}
              className="absolute right-2 top-1/2 transform -translate-y-1/2 w-10 h-10 bg-primary hover:bg-primary/90 text-white rounded-xl flex items-center justify-center transition-all duration-200"
