...
// Variante 3: Forme circulaire, ultra premium
const ChatVariant3 = () => {
  ...
  return (
    <section className="relative min-h-screen w-full flex flex-col items-center justify-center overflow-hidden">
      ...
      {/* Chat Interface - Design circulaire */}
      <motion.div
      ...
      >
        <div className="relative bg-white/98 backdrop-blur-xl border border-white/30 rounded-full p-8 shadow-2xl">
          {/* Message centré */}
          <div className="mb-6 text-center">
            <div className="text-gray-800 text-sm leading-relaxed font-light max-w-md mx-auto h-20 overflow-hidden">
              {typewriterText}
              <motion.span
          ...
          <div className="relative max-w-md mx-auto">
            <Input
              ...
              className="w-full h-12 pr-14 border-gray-200/50 focus:border-primary bg-white/80 backdrop-blur-sm rounded-full text-center"
              onKeyPress={(e) => e.key === 'Enter' && handleSendMessage()}
            />
            <motion.button
              onClick={handleSendMessage}
              className="absolute right-2 top-1/2 transform -translate-y-1/2 w-8 h-8 bg-primary hover:bg-primary/90 text-white rounded-full flex items-center justify-center transition-all duration-200"
