...
const HeroAlternative13 = () => {
  ...
  return (
    <section className="relative h-screen overflow-hidden bg-gradient-to-br from-gray-50 via-white to-blue-50 flex items-center justify-center"
      key={key}
    >
      {/* Label */}
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        />
        <motion.div
          className="absolute bottom-10 left-10 w-48 h-48 border border-indigo-100 rounded-full opacity-20"
          animate={{ rotate: -360 }}
