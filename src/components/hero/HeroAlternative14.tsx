    ...
    >
      ...
      <div className="absolute inset-0 opacity-[0.015]">
        <div 
          ...
          style={{
            backgroundImage: `
              linear-gradient(to right, #0090E6 1px, transparent 1px),
              linear-gradient(to bottom, #0090E6 1px, transparent 1px)
            `,
      ...
      <motion.button
        ...
        className="absolute top-6 right-6 z-50 p-3 bg-white border-2 border-gray-100 rounded-2xl text-gray-600 hover:text-primary hover:border-primary transition-all shadow-sm hover:shadow-lg"
          ...
          >
            ...
            <div className="px-8 py-6 bg-gray-50 border-b-2 border-gray-100">
              <div className="flex items-center justify-center space-x-4">
                ...
                />
                <h3 className="text-xl font-bold text-gray-800 tracking-tight">AI System Online</h3>
                <motion.div 
            ...
            <div className="p-10">
              ...
              >
                <div className="flex items-start space-x-4">
                  <motion.div 
                    className="flex-shrink-0 w-10 h-10 bg-gradient-to-br from-primary to-blue-600 rounded-xl flex items-center justify-center shadow-lg"
                    animate={{ 
                      rotate: [0, 10, -10, 0],
                      scale: [1, 1.05, 1]
                    }}
            ...
            <div className="px-8 py-4 bg-gray-50 border-t border-gray-100">
              <div className="flex items-center justify-center">
                <div className="text-xs text-gray-400 tracking-wide uppercase">Premium AI Interface</div>
              </div>
            </div>
          </motion.div>
        </motion.div>
...
export default HeroAlternative14;