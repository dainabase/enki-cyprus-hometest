  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 text-center">
        ...
        >
          <div className="relative w-full bg-black border border-green-400 rounded-lg p-6 min-h-[120px] font-mono shadow-2xl shadow-green-400/20">
            {/* Header terminal */}
            <div className="flex items-center justify-between mb-4 pb-2 border-b border-green-400/30">
              ...
              <div className="text-green-400 text-xs">TERMINAL v2.1.0</div>
            </div>
...
export default HeroAlternative6;