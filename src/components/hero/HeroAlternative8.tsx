      ...
      <div className="relative z-10 text-center">
        ...
        >
          <div className="relative w-full">
            {/* Effet holographique arrière-plan */}
            <motion.div
            ...
            <div className="relative bg-black/40 backdrop-blur-xl border border-cyan-400/50 rounded-2xl p-6 min-h-[120px] shadow-2xl">
              ...
              <div className="relative z-10">
                <div className="flex items-center gap-2 mb-4">
                  <motion.div
                    ...
                    animate={{ 
                      opacity: [1, 0.5, 1],
                      boxShadow: ["0 0 5px hsl(var(--cyan))", "0 0 20px hsl(var(--cyan))", "0 0 5px hsl(var(--cyan))"]
                    }}
                    transition={{ duration: 1, repeat: Infinity }}
                  />
                  <span className="text-xs text-cyan-400 font-mono tracking-wider">AI_SYSTEM_ONLINE</span>
                </div>
                
                <div className="text-cyan-100 font-mono flex items-start">
...
export default HeroAlternative8;