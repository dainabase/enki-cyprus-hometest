...
export const mockProperties: Property[] = [
  ...
  {
    id: '11',
    title: 'Appartement Design Larnaca Marina',
    description: 'Appartement contemporain dans la nouvelle marina de Larnaca, finitions premium et services haut de gamme.',
    price: '€495,000',
    ...
    area: '110 m²',
    image: '/placeholder-apartment.jpg',
    features: ['Marina view', 'Services concierge', 'Piscine infinity', 'Salle de sport'],
    status: 'available',
    lat: 34.9176,
    lng: 33.6351,
    priceValue: 495000
  ...
  {
    id: '12',
    title: 'Villa Contemporaine Kyrenia',
    description: 'Villa d\'exception avec architecture moderne, située sur les hauteurs de Kyrenia avec vue panoramique.',
    price: '€1,650,000',
    location: 'Kyrenia Hills',
    type: 'villa',
    bedrooms: 4,
    bathrooms: 3,
    area: '380 m²',
    image: '/placeholder-luxury-villa.jpg',
    features: ['Vue panoramique', 'Design contemporain', 'Piscine infinity', 'Cave à vin', 'Bureau'],
    status: 'available',
    lat: 35.3411,
    lng: 33.3184,
    priceValue: 1650000
  ...
  {
    id: '13',
    title: 'Local Commercial Moderne Limassol',
    description: 'Espace commercial neuf dans le quartier d\'affaires de Limassol, idéal pour bureaux ou showroom.',
    price: '€720,000',
    location: 'Business District, Limassol',
    type: 'commercial',
    area: '180 m²',
    image: '/placeholder-commercial.jpg',
    features: ['Neuf', 'Parking privé', 'Climatisation', 'Sécurité', 'Ascenseur'],
    status: 'available',
    lat: 34.6851,
    lng: 33.0401,
    priceValue: 720000
  ...
  {
    id: '14',
    title: 'Maison de Village Omodos',
    description: 'Authentique maison de village dans le pittoresque Omodos, entièrement rénovée avec matériaux nobles.',
    price: '€320,000',
    location: 'Village d\'Omodos',
    type: 'maison',
    bedrooms: 3,
    bathrooms: 2,
    area: '120 m²',
    image: '/placeholder-villa.jpg',
    features: ['Pierre traditionnelle', 'Poutres apparentes', 'Terrasse', 'Jardin', 'Proximité vignobles'],
    status: 'available',
    lat: 34.8539,
    lng: 32.7247,
    priceValue: 320000
  ...
  {
    id: '15',
    title: 'Penthouse Exclusive Famagouste',
    description: 'Penthouse d\'exception face à la mer dans la nouvelle zone résidentielle de Famagouste.',
    price: '€850,000',
    location: 'Nouvelle Famagouste',
    type: 'penthouse',
    bedrooms: 3,
    bathrooms: 2,
    area: '220 m²',
    image: '/placeholder-penthouse.jpg',
    features: ['Vue mer directe', 'Terrasse 80m²', 'Jacuzzi privé', 'Parking double', 'Stockage'],
    status: 'reserved',
    lat: 35.1264,
    lng: 33.9456,
    priceValue: 850000
