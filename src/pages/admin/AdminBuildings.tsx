...
import { Building2, Search, Chrome as Home, Layers, Plus } from 'lucide-react';
...
const AdminBuildings = () => {
  ...
  const handleManageBuilding = (building) => {
    navigate(`/admin/projects/${building.project_id}/dashboard?tab=buildings`);
  };
    ...
    <div className="space-y-6">
      ...
      <div className="sticky top-0 z-20 -mx-6 -mt-6 px-6 pt-6 pb-4 bg-gradient-to-br from-slate-50 via-white to-blue-50/30 backdrop-blur-sm border-b border-slate-200 shadow-sm">
        <div className="flex justify-between items-center">
          <div>
            <h1 className="text-3xl font-bold bg-gradient-to-r from-[hsl(199,63%,59%)] to-[hsl(199,63%,65%)] bg-clip-text text-transparent">Bâtiments</h1>
            <p className="text-slate-600 mt-1">
              Gérez tous les bâtiments de vos projets immobiliers
            </p>
          </div>
          <Button onClick={() => navigate('/admin/buildings/new')} className="gap-2 bg-gradient-to-r from-[hsl(199,63%,59%)] to-[hsl(199,63%,65%)] hover:from-[hsl(199,63%,55%)] hover:to-[hsl(199,63%,60%)] shadow-md hover:shadow-lg transition-all">
