...
export const AdminProjectForm: React.FC = () => {
  ...
  const form = useForm({
    ...
    defaultValues: {
      ...
      amenities: [],
      status: 'available',
      statut_commercial: undefined,
      statut_travaux: undefined,
  ...
  React.useEffect(() => {
    if (projectData && isEdit) {
      ...
      const formData = {
        ...
        statut_commercial: projectData.statut_commercial || undefined,
        statut_travaux: projectData.statut_travaux || undefined,
