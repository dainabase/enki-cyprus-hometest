...
const AdminProjectForm: React.FC = () => {
  ...
  return (
    <div className="h-screen bg-gradient-to-br from-slate-50 to-slate-100 flex flex-col">
      {/* Header - Full Width */}
      <div className="sticky top-0 z-10 bg-white border-b border-slate-200 shadow-sm w-full">
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <div className="w-80 bg-white border-r border-slate-200 shadow-sm flex-shrink-0 flex flex-col overflow-hidden">
          {/* Sidebar Header Area */}
