-- Corriger le type de la colonne location et insérer des données de test
-- D'abord, changer le type de location de jsonb à text
ALTER TABLE public.projects ALTER COLUMN location TYPE text USING location::text;

-- Insérer des projets de test avec les bonnes colonnes
