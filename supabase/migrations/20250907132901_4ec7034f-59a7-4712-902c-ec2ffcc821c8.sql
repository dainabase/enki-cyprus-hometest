...
-- 4. Enrichir la table properties existante pour les unités
ALTER TABLE projects 
...
-- 5. Zones géographiques pour Chypre
CREATE TYPE IF NOT EXISTS cyprus_zone AS ENUM ('limassol', 'paphos', 'larnaca', 'nicosia', 'famagusta', 'kyrenia');

-- 6. Trigger pour Golden Visa automatique
...
-- 9. Policies RLS pour les développeurs
...
-- 10. Policies RLS pour les bâtiments
...
-- 12. Données de test pour développeurs
