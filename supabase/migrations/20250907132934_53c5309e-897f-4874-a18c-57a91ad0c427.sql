...
-- Phase 1: Créer les nouvelles tables et colonnes
...
-- 3. Ajouter la colonne golden_visa_eligible d'abord
ALTER TABLE projects 
ADD COLUMN IF NOT EXISTS golden_visa_eligible BOOLEAN DEFAULT false;

-- 4. Enrichir la table projects avec les nouveaux champs
ALTER TABLE projects 
...
-- 6. Policies RLS pour les développeurs
...
-- 7. Policies RLS pour les bâtiments
...
-- 8. Données de test pour développeurs
