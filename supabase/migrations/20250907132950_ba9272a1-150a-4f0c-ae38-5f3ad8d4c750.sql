...
ADD COLUMN IF NOT EXISTS cyprus_zone TEXT DEFAULT 'limassol' CHECK (cyprus_zone IN ('limassol', 'paphos', 'larnaca', 'nicosia', 'famagusta', 'kyrenia'));

-- 4. Trigger pour Golden Visa automatique
...
-- 7. Policies RLS pour les développeurs
...
-- 8. Policies RLS pour les bâtiments
...
-- 10. Données de test pour développeurs
