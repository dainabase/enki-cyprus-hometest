-- Migration: Create properties table (structure de base) - FIXED
-- Les propriétés héritent des prestations du projet parent

-- Supprimer les triggers existants s'ils existent
DROP TRIGGER IF EXISTS update_properties_updated_at ON public.properties;
DROP TRIGGER IF EXISTS inherit_developer_trigger ON public.properties;
DROP TRIGGER IF EXISTS update_building_units_trigger ON public.properties;

-- Supprimer les fonctions existantes
DROP FUNCTION IF EXISTS public.inherit_developer_from_project();
DROP FUNCTION IF EXISTS public.update_building_units_count();
