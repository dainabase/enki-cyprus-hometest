-- Migration: Add equipment and features fields to properties table
...
-- Contraintes supplémentaires pour cohérence
ALTER TABLE public.properties
ADD CONSTRAINT IF NOT EXISTS check_furniture_value CHECK (
