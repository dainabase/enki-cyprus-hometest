-- ÉTAPE 2/3 : IMPORT DES DONNÉES AVEC MAPPING INTELLIGENT (TYPES CORRIGÉS)
-- =======================================================

-- 1. IMPORT DEVELOPERS (21 entrées) - FIXED ALL TYPE ISSUES
...
SELECT 
  ...
  website, 
  -- Fix type casting for phone_numbers (text[] -> jsonb)
  CASE 
  ...
  insurance_coverage, 
  -- Fix bank_guarantee: boolean -> numeric (1 if true, 0 if false)
...
SELECT 
  ...
  -- Handle array to jsonb conversion
  CASE 
